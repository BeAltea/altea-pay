...
-- Corrigido para usar 'cnpj' ao invés de 'document'
...
-- Corrigido para usar 'document' na tabela customers (que mantém o nome original)
        ...
        FOR i IN 1..(1 + floor(random() * 3)::int) LOOP
            ...
            INSERT INTO public.debts (
                ...
                CASE 
                    ...
                    WHEN customer_record.company_id = '44444444-4444-4444-4444-444444444444' THEN 'Conta de Energia Cemig - ' || to_char(current_date - interval '1 month' * i, 'MM/YYYY')
                    ELSE 'Conta de Água Copasa - ' || to_char(current_date - interval '1 month' * i, 'MM/YYYY')
                END,
